...
//     'https://via.placeholder.com/150', // Bags Image
//     'https://via.placeholder.com/150', // Lingerie Image
//   ];
//
//   @override
...
//                 children: const [
//                   Chip(label: Text("To Pay", style: TextStyle(color: Colors.blue))),
//                   Chip(label: Text("To Receive", style: TextStyle(color: Colors.blue))),
//                   Chip(label: Text("To Review", style: TextStyle(color: Colors.blue))),
//                 ],
//               ),
...
//               SectionTitle(title: "Categories", onSeeAllPressed: () {}),
//               GridView.builder(
//                 shrinkWrap: true,
...
//                     imageUrl: widget.categoryImages[index],
//                   );
//                 },
//               ),
//             ],
...
//
//   const CategoryCard({required this.title, required this.imageUrl, Key? key}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     return Column(
